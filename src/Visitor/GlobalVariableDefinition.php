...
class GlobalVariableDefinition extends DefinitionVisitor
{
    /**
     * @param Node $node
     */
     ...
     * @param Node $node
     */
    protected function processNode(Node\Stmt\Global_ $node)
    {
        foreach ($node->vars as $variable) {
            $this->createTag('variable', $variable->name, $variable);
        }
    }
}
